...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){let r=new Float32Array(Do),i=new U(0,1,0);return new ya({name:`SphericalGaussianBlur`,defines:{n:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(){return new ya({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new ya({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wo(),fragmentShader:`
...
Near-term risk.`,description:`No direct core passage in the 72-hour CMA track. Beijing’s threat is remote moisture transport.`}};function tu(e){return{TD:`Tropical depression`,TS:`Tropical storm`,STS:`Severe tropical storm`,TY:`Typhoon`,STY:`Severe typhoon`,SuperTY:`Super typhoon`}[e]??e}function nu(e,t,n,r){let i=e=>e*Math.PI/180,a=i(n-e),o=i(r-t),s=Math.sin(a/2)**2+Math.cos(i(e))*Math.cos(i(n))*Math.sin(o/2)**2;return 6371*2*Math.atan2(Math.sqrt(s),Math.sqrt(1-s))}function ru(e,t=!0){let n=new Date(e);return Number.isNaN(n.getTime())?`Awaiting timestamp`:new Intl.DateTimeFormat(`en-GB`,{timeZone:`Asia/Shanghai`,month:t?`short`:void 0,day:t?`2-digit`:void 0,hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(n)}function iu(e,t){return new U((e-137)*.22,(t-25)*.245,.12)}function au(e,t=!1){let n=document.createElement(`canvas`);n.width=384,n.height=80;let r=n.getContext(`2d`);if(!r)return new Hr;r.clearRect(0,0,n.width,n.height),r.font=`600 25px Arial`,r.letterSpacing=`4px`,r.fillStyle=t?`#ffb967`:`#83bed0`,r.fillText(e,12,48);let i=new Ui(n);i.colorSpace=Je;let a=new Hr(new Or({map:i,transparent:!0,opacity:t?.92:.55,depthWrite:!1}));return a.scale.set(2.2,.46,1),a}function ou({data:e,view:t,replayIndex:n}){let r=(0,l.useRef)(null),i=(0,l.useRef)(t),a=(0,l.useRef)(n);return(0,l.useEffect)(()=>{i.current=t},[t]),(0,l.useEffect)(()=>{a.current=n},[n]),(0,l.useEffect)(()=>{let t=r.current;if(!t)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,o=new kl({antialias:!0,alpha:!0,powerPreference:`high-performance`});o.setPixelRatio(Math.min(window.devicePixelRatio,1.55)),o.setSize(t.clientWidth,t.clientHeight),o.setClearColor(0,0),o.outputColorSpace=Je,t.appendChild(o.domElement);let s=new On;s.fog=new Dn(132621,.035);let c=new qa(38,t.clientWidth/t.clientHeight,.1,100);c.position.set(0,0,15.5);let l=new vn;l.rotation.x=-.08,l.rotation.z=-.025,s.add(l);let u=new Si({color:2988977,transparent:!0,opacity:.12}),d=new Sr,f=[];for(let e=105;e<=165;e+=5){let t=iu(e,3),n=iu(e,48);f.push(t.x,t.y,0,n.x,n.y,0)}for(let e=5;e<=45;e+=5){let t=iu(105,e),n=iu(165,e);f.push(t.x,t.y,0,n.x,n.y,0)}d.setAttribute(`position`,new ur(f,3)),l.add(new Ni(d,u));let p=new ui(new la(14.8,11.7),new Qr({color:401709,transparent:!0,opacity:.1,depthWrite:!1}));p.position.z=-.04,l.add(p);let m=new vn;for(let[e,t,n,r]of[[`BEIJING`,116.4074,39.9042,!0],[`SHANGHAI`,121.4737,31.2304,!1],[`TAIPEI`,121.5654,25.033,!1],[`MANILA`,120.9842,14.5995,!1],[`TOKYO`,139.6917,35.6895,!1]]){let i=iu(t,n),a=new ui(new Ji(r?.07:.035,24),new Qr({color:r?16757852:7718360,transparent:!0,opacity:r?1:.48}));a.position.copy(i),a.position.z=.18,m.add(a);let o=au(e,r);o.position.copy(i),o.position.x+=.74,o.position.y+=.18,o.position.z=.22,o.scale.multiplyScalar(r?.76:.6),m.add(o)}l.add(m);let h=e.observed.map(e=>iu(e.longitude,e.latitude)),g=e.storm.current??e.observed[e.observed.length-1],_=[iu(g.longitude,g.latitude),...e.forecast.map(e=>iu(e.longitude,e.latitude))],v=new ra(h,!1,`centripetal`,.32),y=new ki(new Sr().setFromPoints(v.getPoints(Math.max(80,h.length*8))),new Si({color:9300468,transparent:!0,opacity:.82}));y.position.z=.18,l.add(y);let b=null,x=null;if(_.length>1){b=new ra(_,!1,`centripetal`,.3);let e=new Ca({color:12625919,dashSize:.12,gapSize:.1,transparent:!0,opacity:.88});x=new ki(new Sr().setFromPoints(b.getPoints(100)),e),x.computeLineDistances(),x.position.z=.2,l.add(x)}let S=window.innerWidth<760?80:180,C=new Float32Array(S*3),w=new Sr;w.setAttribute(`position`,new sr(C,3));let T=new Bi(w,new Fi({color:10352639,size:window.innerWidth<760?.045:.035,transparent:!0,opacity:.8,blending:2,depthWrite:!1}));T.position.z=.21,l.add(T);let E=new vn;l.add(E);let D=window.innerWidth<760?2200:6200,O=new Sr,k=new Float32Array(D),ee=new Float32Array(D),te=new Float32Array(D);for(let e=0;e<D;e+=1)k[e]=.05+Math.random()**.72*1.42,ee[e]=Math.random()*Math.PI*2,te[e]=Math.random()*Math.PI*2;O.setAttribute(`position`,new sr(new Float32Array(D*3),3)),O.setAttribute(`aRadius`,new sr(k,1)),O.setAttribute(`aAngle`,new sr(ee,1)),O.setAttribute(`aPhase`,new sr(te,1));let ne=new ya({transparent:!0,blending:2,depthWrite:!1,uniforms:{uTime:{value:0},uMotion:{value:+!n},uColorA:{value:new Tn(8976383)},uColorB:{value:new Tn(10650623)},uOpacity:{value:.9}},vertexShader:`
      ...
      `}),A=new Bi(O,ne);E.add(A);let re=new ui(new ua(.08,.15,64),new Qr({color:15269631,transparent:!0,opacity:.88,blending:2,side:2}));re.position.z=.08,E.add(re);let ie=new vn;for(let e=0;e<3;e+=1){let t=new Pi(new Sr().setFromPoints(new Xi(0,0,.55+e*.36,.43+e*.28,0,Math.PI*2).getPoints(90).map(e=>new U(e.x,e.y,0))),new Si({color:e===2?10980346:7990015,transparent:!0,opacity:.18-e*.035}));ie.add(t)}E.add(ie);let j=iu(jl.longitude,jl.latitude),M=new vn;M.position.copy(j),M.position.z=.24;for(let e=0;e<4;e+=1){let t=new Pi(new Sr().setFromPoints(new Xi(0,0,.16+e*.17,.16+e*.17,0,Math.PI*2).getPoints(72).map(e=>new U(e.x,e.y,0))),new Si({color:16757082,transparent:!0,opacity:.66/(e+1)}));M.add(t)}l.add(M);let ae=window.innerWidth<760?360:1100,oe=new Sr,se=new Float32Array(ae*3),ce=Array.from({length:ae},()=>({progress:Math.random(),offset:(Math.random()-.5)*.82,phase:Math.random()*Math.PI*2,speed:.025+Math.random()*.045}));oe.setAttribute(`position`,new sr(se,3));let le=new Fi({color:8253439,size:window.innerWidth<760?.055:.042,transparent:!0,opacity:0,blending:2,depthWrite:!1}),N=new Bi(oe,le);N.position.z=.2,l.add(N);let P=window.innerWidth<760?400:1e3,ue=new Float32Array(P*3);for(let e=0;e<P;e+=1)ue[e*3]=(Math.random()-.5)*26,ue[e*3+1]=(Math.random()-.5)*18,ue[e*3+2]=-1-Math.random()*10;let de=new Bi(new Sr().setAttribute(`position`,new sr(ue,3)),new Fi({color:7982557,size:.025,transparent:!0,opacity:.34,depthWrite:!1}));s.add(de);let fe=new H,pe=new U,me=new U,he=new U,ge=new uo,_e=0,ve=!document.hidden,ye=e=>{fe.x=(e.clientX/window.innerWidth-.5)*2,fe.y=(e.clientY/window.innerHeight-.5)*2},be=()=>{ve=!document.hidden,ve&&ge.getDelta()},xe=()=>{t&&(c.aspect=t.clientWidth/t.clientHeight,c.updateProjectionMatrix(),o.setSize(t.clientWidth,t.clientHeight),o.setPixelRatio(Math.min(window.devicePixelRatio,1.55)))};window.addEventListener(`pointermove`,ye,{passive:!0}),window.addEventListener(`resize`,xe),document.addEventListener(`visibilitychange`,be);let Se=()=>{if(_e=requestAnimationFrame(Se),!ve)return;let t=ge.getElapsedTime(),r=i.current,l=Math.min(Math.max(a.current,0),e.observed.length-1),u=r===`replay`?e.observed[l]:g,d=iu(u.longitude,u.latitude);E.position.lerp(d,n?1:.075),ne.uniforms.uTime.value=t,ne.uniforms.uOpacity.value=r===`beijing`?.48:.9,re.rotation.z=n?0:-t*.34,ie.rotation.z=n?0:t*.08;let f=n?1:1+Math.sin(t*2.2)*.06;M.scale.setScalar(r===`beijing`?f*1.3:f*.78),M.children.forEach((e,t)=>{let n=e.material;n.opacity=r===`beijing`?.7/(t+1):.2/(t+1)}),x&&(x.material.opacity=r===`replay`?.2:.9),y.material.opacity=r===`beijing`?.34:.84;for(let e=0;e<S;e+=1){let r=n?e/S:(e/S+t*.035)%1,i=v.getPointAt(r);C[e*3]=i.x,C[e*3+1]=i.y,C[e*3+2]=.04}w.attributes.position.needsUpdate=!0;let p=b?b.getPointAt(.62):d,m=new ca(p,new U((p.x+j.x)/2-.55,(p.y+j.y)/2+.55,.2),j);le.opacity+=((r===`beijing`?.78:.02)-le.opacity)*.06;for(let e=0;e<ae;e+=1){let r=ce[e],i=n?r.progress:(r.progress+t*r.speed)%1,a=m.getPointAt(i),o=Math.sin(r.phase+i*15+t*.8)*r.offset*(.4+Math.sin(i*Math.PI)*.6);se[e*3]=a.x+o*.55,se[e*3+1]=a.y+o,se[e*3+2]=.08+Math.sin(r.phase+i*8)*.08}oe.attributes.position.needsUpdate=!0,r===`beijing`?(pe.set(-3.7,2.45,window.innerWidth<760?12.2:9.4),me.set(-3.65,2.1,0)):r===`replay`?(pe.set(-.4,-.1,window.innerWidth<760?17.6:15.8),me.set(-.45,-.15,0)):(pe.set(-.6,-.25,window.innerWidth<760?16.7:14.6),me.set(-.55,-.15,0)),n||(pe.x+=fe.x*.24,pe.y-=fe.y*.16),c.position.lerp(pe,n?1:.035),he.lerp(me,n?1:.045),c.lookAt(he),de.rotation.z=n?0:t*.0025,o.render(s,c)};return Se(),()=>{cancelAnimationFrame(_e),window.removeEventListener(`pointermove`,ye),window.removeEventListener(`resize`,xe),document.removeEventListener(`visibilitychange`,be),s.traverse(e=>{let t=e;t.geometry?.dispose?.(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material?.dispose?.()}),o.dispose(),o.domElement.remove()}},[e]),(0,X.jsx)(`div`,{className:`scene-host`,ref:r,"aria-hidden":`true`})}function su(){let[e,t]=(0,l.useState)($l),[n,r]=(0,l.useState)(`snapshot`),[i,a]=(0,l.useState)(`live`),[o,s]=(0,l.useState)($l.observed.length-1),[c,u]=(0,l.useState)(!1),[d,f]=(0,l.useState)($l.generatedAt);(0,l.useEffect)(()=>{let e=!0,n,i,a=async()=>{if(document.hidden)return;i?.abort(),i=new AbortController;let o=window.setTimeout(()=>i?.abort(),24e3);try{let n=await Jl(i.signal);if(!e)return;t(n),s(n.observed.length-1);let a=Date.now()-new Date(n.updatedAt).getTime();r(n.status.mode===`live`?a<360*60*1e3?`live`:`delayed`:`snapshot`),f(new Date().toISOString()),Xl(n)}catch{if(!e)return;let n=Yl();n?(t(n),s(n.observed.length-1),r(`delayed`)):r(`snapshot`)}finally{window.clearTimeout(o),e&&(n=setTimeout(a,300*1e3))}},o=()=>{document.hidden||a()};return a(),window.addEventListener(`online`,o),document.addEventListener(`visibilitychange`,o),()=>{e=!1,i?.abort(),n&&clearTimeout(n),window.removeEventListener(`online`,o),document.removeEventListener(`visibilitychange`,o)}},[]),(0,l.useEffect)(()=>{if(!c||i!==`replay`)return;let t=window.setInterval(()=>{s(t=>t>=e.observed.length-1?0:t+1)},720);return()=>window.clearInterval(t)},[c,i,e.observed.length]),(0,l.useEffect)(()=>{let t=t=>{t.key===`1`&&a(`live`),t.key===`2`&&a(`replay`),t.key===`3`&&a(`beijing`),i===`replay`&&t.key===`ArrowLeft`&&s(e=>Math.max(0,e-1)),i===`replay`&&t.key===`ArrowRight`&&s(t=>Math.min(e.observed.length-1,t+1)),i===`replay`&&t.key===` `&&(t.preventDefault(),u(e=>!e))};return window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[i,e.observed.length]);let p=i===`replay`?e.observed[o]??e.storm.current:e.storm.current,m=eu[i],h=e.beijing.closestForecast,g=(0,l.useMemo)(()=>Math.max(...e.observed.map(e=>e.maxWindMs??0)),[e.observed]),_=e=>{a(e),e!==`replay`&&u(!1)};return(0,X.jsxs)(`main`,{className:`experience view-${i}`,children:[(0,X.jsx)(`div`,{className:`atmosphere`}),(0,X.jsx)(ou,{data:e,view:i,replayIndex:o}),(0,X.jsxs)(`header`,{className:`topbar`,children:[(0,X.jsxs)(`a`,{className:`brand`,href:`#top`,"aria-label":`Aether Storm Observatory home`,children:[(0,X.jsxs)(`span`,{className:`brand-mark`,children:[(0,X.jsx)(`i`,{}),(0,X.jsx)(`i`,{}),(0,X.jsx)(`i`,{})]}),(0,X.jsx)(`span`,{children:`AETHER`}),(0,X.jsx)(`small`,{children:`STORM OBSERVATORY`})]}),(0,X.jsx)(`nav`,{className:`view-nav`,"aria-label":`Visualization views`,children:[`live`,`replay`,`beijing`].map(e=>(0,X.jsxs)(`button`,{className:i===e?`active`:``,onClick:()=>_(e),"aria-pressed":i===e,children:[(0,X.jsx)(`span`,{children:eu[e].index}),eu[e].kicker]},e))}),(0,X.jsxs)(`div`,{className:`feed-state state-${n}`,title:`Last checked ${ru(d)} CST`,children:[(0,X.jsx)(`span`,{className:`status-dot`}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`strong`,{children:n}),(0,X.jsx)(`small`,{children:`CMA / NMC FEED`})]})]})]}),(0,X.jsxs)(`section`,{className:`hero-copy`,id:`top`,children:[(0,X.jsxs)(`div`,{className:`eyebrow`,children:[(0,X.jsx)(`span`,{children:m.index}),m.kicker]}),(0,X.jsxs)(`p`,{className:`storm-id`,children:[`WPAC / 2609 `,(0,X.jsx)(`b`,{children:`BAVI`})]}),(0,X.jsx)(`h1`,{children:m.title.split(`
`).map(e=>(0,X.jsx)(`span`,{children:e},e))}),(0,X.jsx)(`p`,{className:`hero-description`,children:m.description}),(0,X.jsxs)(`div`,{className:`hero-actions`,children:[(0,X.jsxs)(`button`,{className:`primary-action`,onClick:()=>_(i===`beijing`?`live`:`beijing`),children:[(0,X.jsx)(`span`,{children:i===`beijing`?`Return to storm`:`Focus on Beijing`}),(0,X.jsx)(`b`,{children:`↗`})]}),(0,X.jsxs)(`a`,{href:e.source.detailUrl,target:`_blank`,rel:`noreferrer`,children:[`Official source `,(0,X.jsx)(`span`,{children:`↗`})]})]})]}),(0,X.jsxs)(`aside`,{className:`telemetry glass-panel`,"aria-label":`Current storm telemetry`,children:[(0,X.jsxs)(`div`,{className:`panel-heading`,children:[(0,X.jsx)(`span`,{children:`CORE TELEMETRY`}),(0,X.jsxs)(`small`,{children:[ru(p.validAt),` CST`]})]}),(0,X.jsxs)(`div`,{className:`primary-reading`,children:[(0,X.jsx)(`strong`,{children:p.maxWindMs??`—`}),(0,X.jsxs)(`span`,{children:[`m/s`,(0,X.jsx)(`small`,{children:`MAX WIND · CMA 2-MIN`})]})]}),(0,X.jsxs)(`div`,{className:`metric-grid`,children:[(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`small`,{children:`PRESSURE`}),(0,X.jsxs)(`b`,{children:[p.pressureHpa??`—`,` `,(0,X.jsx)(`i`,{children:`hPa`})]})]}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`small`,{children:`CLASS`}),(0,X.jsx)(`b`,{children:p.classification.code})]}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`small`,{children:`POSITION`}),(0,X.jsxs)(`b`,{children:[p.latitude.toFixed(1),`°N `,(0,X.jsx)(`i`,{children:`/`}),` `,p.longitude.toFixed(1),`°E`]})]}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`small`,{children:`MOTION`}),(0,X.jsxs)(`b`,{children:[p.movement?.direction??`NW`,` `,(0,X.jsxs)(`i`,{children:[p.movement?.speedKmh??21,` km/h`]})]})]})]}),(0,X.jsx)(`div`,{className:`intensity-bar`,children:(0,X.jsx)(`span`,{style:{width:`${Math.min(100,(p.maxWindMs??0)/70*100)}%`}})}),(0,X.jsxs)(`div`,{className:`scale-label`,children:[(0,X.jsx)(`span`,{children:`TD`}),(0,X.jsx)(`span`,{children:`TS`}),(0,X.jsx)(`span`,{children:`TY`}),(0,X.jsx)(`span`,{children:`SUPER TY`})]})]}),(0,X.jsxs)(`aside`,{className:`impact-panel glass-panel ${i===`beijing`?`visible`:``}`,"aria-label":`Beijing impact assessment`,children:[(0,X.jsxs)(`div`,{className:`warning-line`,children:[(0,X.jsx)(`span`,{className:`warning-symbol`,children:`!`}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`small`,{children:`BEIJING · ACTIVE`}),(0,X.jsx)(`strong`,{children:`ORANGE RAINSTORM WARNING`})]})]}),(0,X.jsxs)(`p`,{className:`mechanism`,children:[`REMOTE MOISTURE `,(0,X.jsx)(`span`,{children:`/`}),` FAR-FIELD RAIN`]}),(0,X.jsxs)(`p`,{className:`impact-summary`,children:[`The primary risk is long-range moisture transport interacting with cold air — `,(0,X.jsx)(`b`,{children:`not direct eyewall passage.`})]}),(0,X.jsxs)(`div`,{className:`rain-metrics`,children:[(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`strong`,{children:`70+`}),(0,X.jsxs)(`span`,{children:[`mm/h`,(0,X.jsx)(`small`,{children:`LOCAL POTENTIAL`})]})]}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`strong`,{children:`150+`}),(0,X.jsxs)(`span`,{children:[`mm/24h`,(0,X.jsx)(`small`,{children:`LOCAL POTENTIAL`})]})]})]}),(0,X.jsxs)(`div`,{className:`impact-route`,children:[(0,X.jsxs)(`span`,{children:[(0,X.jsx)(`i`,{}),`STORM CORE`]}),(0,X.jsxs)(`b`,{children:[Math.round(e.beijing.currentDistanceKm).toLocaleString(),` km`]}),(0,X.jsxs)(`span`,{children:[(0,X.jsx)(`i`,{}),`BEIJING`]})]}),(0,X.jsxs)(`div`,{className:`forecast-clearance`,children:[(0,X.jsx)(`span`,{children:`NEAREST 72H FORECAST`}),(0,X.jsxs)(`strong`,{children:[Math.round(h?.distanceKm??e.beijing.minDistanceKm??791),` km south`]})]}),(0,X.jsxs)(`div`,{className:`districts`,children:[(0,X.jsx)(`span`,{children:`HUAIROU`}),(0,X.jsx)(`span`,{children:`MIYUN`}),(0,X.jsx)(`span`,{children:`PINGGU`}),(0,X.jsx)(`span`,{children:`SHUNYI`}),(0,X.jsx)(`span`,{children:`FANGSHAN`})]}),(0,X.jsxs)(`a`,{className:`warning-link`,href:`https://www.beijing.gov.cn/ywdt/yaowen/202607/t20260709_4755249.html`,target:`_blank`,rel:`noreferrer`,children:[`Read official Beijing warning `,(0,X.jsx)(`span`,{children:`↗`})]})]}),(0,X.jsxs)(`section`,{className:`replay-controls glass-panel ${i===`replay`?`visible`:``}`,"aria-label":`Track replay controls`,children:[(0,X.jsx)(`button`,{className:`play-button`,onClick:()=>u(e=>!e),"aria-label":c?`Pause replay`:`Play replay`,children:c?`Ⅱ`:`▶`}),(0,X.jsxs)(`div`,{className:`replay-track`,children:[(0,X.jsxs)(`div`,{className:`replay-meta`,children:[(0,X.jsxs)(`span`,{children:[`ANALYSIS `,String(o+1).padStart(2,`0`),` / `,String(e.observed.length).padStart(2,`0`)]}),(0,X.jsxs)(`strong`,{children:[ru(p.validAt),` CST`]})]}),(0,X.jsx)(`input`,{"aria-label":`Historical track position`,type:`range`,min:`0`,max:Math.max(0,e.observed.length-1),value:o,onChange:e=>s(Number(e.target.value)),style:{"--replay-progress":`${o/Math.max(1,e.observed.length-1)*100}%`}}),(0,X.jsxs)(`div`,{className:`replay-dates`,children:[(0,X.jsx)(`span`,{children:`GENESIS · 02 JUL`}),(0,X.jsxs)(`span`,{children:[`LATEST · `,ru(e.updatedAt)]})]})]}),(0,X.jsxs)(`div`,{className:`peak-stat`,children:[(0,X.jsx)(`small`,{children:`PEAK INTENSITY`}),(0,X.jsxs)(`strong`,{children:[g,` m/s`]})]})]}),(0,X.jsxs)(`div`,{className:`forecast-rail`,"aria-label":`CMA forecast timeline`,children:[(0,X.jsx)(`span`,{className:`rail-label`,children:`CMA FORECAST`}),e.forecast.slice(0,6).map(e=>(0,X.jsxs)(`button`,{onClick:()=>_(`live`),title:`${e.latitude.toFixed(1)}°N, ${e.longitude.toFixed(1)}°E`,children:[(0,X.jsx)(`i`,{className:e.classification.code.toLowerCase()}),(0,X.jsxs)(`span`,{children:[`+`,e.leadHours,`H`]}),(0,X.jsx)(`strong`,{children:e.classification.code})]},`${e.validAt}-${e.leadHours}`))]}),(0,X.jsxs)(`footer`,{className:`source-strip`,children:[(0,X.jsxs)(`span`,{children:[`DATA `,(0,X.jsx)(`b`,{children:`CMA / NMC`})]}),(0,X.jsxs)(`span`,{children:[`ANALYSIS `,(0,X.jsxs)(`b`,{children:[ru(e.updatedAt),` CST`]})]}),(0,X.jsxs)(`span`,{children:[`REFRESH `,(0,X.jsx)(`b`,{children:`5 MIN`})]}),(0,X.jsx)(`span`,{className:`source-note`,children:`Forecast guidance changes. Follow official warnings for safety decisions.`})]}),(0,X.jsxs)(`div`,{className:`coordinate-badge`,"aria-hidden":`true`,children:[(0,X.jsx)(`span`,{children:`39.9042°N`}),(0,X.jsx)(`i`,{}),(0,X.jsx)(`span`,{children:`116.4074°E`})]}),(0,X.jsxs)(`div`,{className:`corner-index`,"aria-hidden":`true`,children:[`A-09`,(0,X.jsx)(`br`,{}),(0,X.jsx)(`span`,{children:`2026`})]}),(0,X.jsxs)(`section`,{className:`sr-only`,"aria-label":`Accessible storm summary`,children:[(0,X.jsx)(`h2`,{children:`Typhoon Bavi live data summary`}),(0,X.jsxs)(`p`,{children:[`Latest CMA analysis: `,p.classification.label,`, maximum wind `,p.maxWindMs,` metres per second, pressure `,p.pressureHpa,` hectopascals, at `,p.latitude,` degrees north and `,p.longitude,` degrees east.`]}),(0,X.jsxs)(`p`,{children:[`Beijing is approximately `,Math.round(e.beijing.currentDistanceKm),` kilometres from the current center. The severe rainfall risk is caused by far-field moisture transport, not direct eyewall passage.`]})]})]})}var cu=document.getElementById(`root`);if(!cu)throw Error(`Static application root was not found`);(0,u.createRoot)(cu).render((0,X.jsx)(su,{}));